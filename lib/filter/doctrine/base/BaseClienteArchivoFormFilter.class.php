...
/**
 * ClienteArchivo filter form base class.
 *
 * @package    tramimundo
 * @subpackage filter
 ...
 */
abstract class BaseClienteArchivoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cliente_archivo_filters[%s]');
