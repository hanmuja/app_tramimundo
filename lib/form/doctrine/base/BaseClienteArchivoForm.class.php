...
/**
 * ClienteArchivo form base class.
 *
 * @method ClienteArchivo getObject() Returns the current form's model object
 *
 * @package    tramimundo
 * @subpackage form
 ...
 */
abstract class BaseClienteArchivoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cliente_archivo[%s]');
