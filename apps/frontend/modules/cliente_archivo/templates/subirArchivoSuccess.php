...
<h2>Subir Archivo CSV para actualizar Clientes</h2>
<br />
<br />
...
<form action="<?php echo url_for('cliente_archivo/subirArchivo') ?>" method="POST" enctype="multipart/form-data">
  <?php echo $form ?>
...
<br /><br />
<p>
El encabezado del archivo debe ser el siguiente (aqui se omiten las columnas que no tienen que ver con los datos):<br />
Billing Document;Material;Material Description;HS Code CH;UoM;Packed quantity;Value;Country of origin
</p>
</div>